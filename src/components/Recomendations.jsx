...
export default function Recomendations (){
  ...
  const cards = [
    ...
    const titleStyle1 = "text-terciary font-bold text-xl py-2 px-4 xl:text-2xl  dark:text-gray-300"

    const subTitleStyle0 = "text-white text-md px-4 xl:text-xl"
    const subTitleStyle1 = "text-terciary text-md px-4 xl:text-xl dark:text-gray-300"
  ...
  return(
    ...
    <div className="Galery flex h-72 w-auto items-center mt-6  overflow-x-hidden overscroll-x-contain space-x-4 overflow-y-hidden xl:h-96">
      {
        cards.map( (card) => ( 
